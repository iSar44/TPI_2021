...
if ($submit) {
    ...
    if ($dateHeureDemarrage > $dateHeureFinInscription && $dateHeureFinInscription > $dateHeureDebutInscription) {
        ...
        $leTournoi = new Tournoi_tM((int)$_GET['id'], $titreTournoi, $description, $dateHeureDemarrage, $nbEquipes, $dateHeureDebutInscription, $dateHeureFinInscription, $tempsEntreRondes);
        ...
        <div id="formdiv">
            <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                ...
                <div class="col-md-10 offset-md-1">
                    <input type="text" value='<?= $selectedTournament->getTitre(); ?>' class="form-control" style="margin-left:0px;font-family:Roboto, sans-serif;" name="titreTournoi" placeholder="Titre" required />
                </div>
            </div>
            <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                <div class="col-md-8 offset-md-1">
                ...
                <div class="col-md-10 offset-md-1">
                    <textarea class="form-control" style="font-family:Roboto, sans-serif;" name="description" placeholder="Description" required><?= $selectedTournament->getDescription(); ?></textarea>
                </div>
            </div>
            <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                <div class="col-md-8 offset-md-1">
                ...
                <div class="col-md-10 offset-md-1">
                    <input class="form-control" value='<?= date("Y-m-d\TH:i:s", strtotime($selectedTournament->getDateHeureDemarrage())); ?>' style="font-family:Roboto, sans-serif;" name="dateHeureDemarrageTournoi" type="datetime-local" required />
                </div>
            </div>
            <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px">
                <div class="col-md-8 offset-md-1">
                ...
                <div class="col-md-10 offset-md-1">
                    <select class="form-select" style="font-family:Roboto, sans-serif;" name="nbEquipes" required>
                        ...
                        <option value='<?= $selectedTournament->getNbEquipes(); ?>' selected><?= $selectedTournament->getNbEquipes(); ?></option>
                        <?php if ($selectedTournament->getNbEquipes() == 16) : ?>
            ...
            <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                ...
                <div class="col-md-10 offset-md-1">
                    <input class="form-control" value='<?= date("Y-m-d\TH:i:s", strtotime($selectedTournament->getDateHeureDebutInscription())); ?>' style="font-family:Roboto, sans-serif;" name="dateHeureDebutInscription" type="datetime-local" required />
                </div>
            </div>
            <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                <div class="col-md-8 offset-md-1">
                ...
                <div class="col-md-10 offset-md-1">
                    <input class="form-control" value='<?= date("Y-m-d\TH:i:s", strtotime($selectedTournament->getDateHeureFinInscription())); ?>' style="font-family:Roboto, sans-serif;" name="dateHeureFinInscription" type="datetime-local" required />
                </div>
            </div>
            <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                <div class="col-md-8 offset-md-1">
                ...
                <div class="col-md-10 offset-md-1">
                    <input type="time" value='<?= $selectedTournament->getTempsEntreRondes(); ?>' class="form-control" style="margin-left:0px;font-family:Roboto, sans-serif;" name="tempsEntreRondes" />
                </div>
            </div>
