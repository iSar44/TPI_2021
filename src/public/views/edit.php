...
$selectedTournament = $t_controller->SelectTournament($_GET['id']);
...
<head>
    ...
    <link rel="stylesheet" href="/TPI_2021/src/public/assets/css/Create-Tournament-Form.css">
...
<body class="d-flex flex-column min-vh-100">
    ...
    <div style="margin-top:5vh;">
        <?php require_once('./src/public/views/struct/editForm.php'); ?>
    </div>
